...
struct WorkContextTests {
    ...
    func testCustomInit() {
        ...
        #expect(context.ticketKey == "AIR-1234")
        #expect(context.title == "항공권 예약 플로우 개선")
    ...
    func testDisplayLabel() {
        let contextWithKey = WorkContext(ticketKey: "AIR-1234", title: "테스트 제목")
        #expect(contextWithKey.displayLabel == "AIR-1234")
